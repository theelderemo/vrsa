/**
 * MentionInput - Input component with @ mention autocomplete
...
const MentionInput = ({
  ...
  const detectMention = useCallback((text, cursorPosition) => {
    ...
    // Check if there's a space between @ and cursor (if so, not mentioning)
  ...
  return (
    <div className="relative flex-1">
      ...
      {showSuggestions && (
        <div 
          ref={suggestionsRef}
          className="absolute bottom-full left-0 right-0 mb-1 bg-slate-800 border border-slate-600 rounded-lg shadow-xl overflow-hidden z-50 max-h-48 overflow-y-auto"
        >
          {loading ? (
